...
DROP TABLE IF EXISTS `jpa_menu`;

CREATE TABLE `jpa_menu` (
...
/*Data for the table `jpa_role` */

insert  into `jpa_role`(`role_id`,`gmt_create`,`gmt_modified`,`role_name`) values (1,'2019-09-02 22:28:27','2019-09-03 23:42:49','销售经理'),(2,'2019-09-02 22:28:57','2019-09-02 22:29:00','销售员'),(3,'2019-09-03 23:42:35','2019-09-03 23:42:35','采购经理'),(4,'2019-08-06 01:55:34','2019-09-03 01:55:31','采购员');

/*Table structure for table `jpa_role_menu` */

DROP TABLE IF EXISTS `jpa_role_menu`;

CREATE TABLE `jpa_role_menu` (
  `role_id` bigint(20) NOT NULL,
  `menu_id` varchar(255) COLLATE utf8_bin NOT NULL,
  PRIMARY KEY (`role_id`,`menu_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

/*Data for the table `jpa_role_menu` */

insert  into `jpa_role_menu`(`role_id`,`menu_id`) values (1,'005904abce6711e9898d026659304345'),(1,'005904abce6711e9898d026659304366'),(1,'005904abce6711e9898d026659345366'),(1,'005904abce6711e9898d045659304345'),(1,'bc2ccd15ce6411e9898d026659304358'),(2,'005904abce6711e9898d026659304366'),(2,'005904abce6711e9898d026659345366'),(2,'005904abce6711e9898d045659304345'),(2,'bc2ccd15ce6411e9898d026659304358'),(3,'005904abce6711e3898d026659304345'),(3,'005904abce6711e9898d023659304345'),(3,'005904abce6711e9898d026659304325'),(3,'005904abce6711e9898d02665930434a'),(3,'005904abce6711e9898d02665930434e'),(4,'005904abce6711e3898d026659304345'),(4,'005904abce6711e9898d023659304345'),(4,'005904abce6711e9898d026659304325'),(4,'005904abce6711e9898d02665930434a');
...
insert  into `jpa_user`(`user_id`,`user_age`,`gmt_create`,`gmt_modified`,`user_name`,`user_role_id`) values (1,19,'2019-09-04 21:48:28','2019-09-04 21:48:32','zzs001',1),(2,18,'2019-09-04 21:48:54','2019-09-01 21:48:57','zzs003',1),(3,20,'2019-09-04 21:49:16','2019-08-21 21:49:19','zzs004',1),(4,25,'2019-08-01 21:49:43','2019-09-02 21:49:49','zzs002',3),(5,26,'2019-09-04 21:54:49','2019-09-04 21:54:51','zzf001',2),(6,15,'2019-09-03 21:55:09','2019-08-08 21:55:12','zzf003',2),(7,23,'2019-09-03 01:56:58','2019-09-03 01:57:03','zzf002',3),(8,23,'2019-09-05 01:57:50','2019-09-01 01:57:47','zzf004',4);
