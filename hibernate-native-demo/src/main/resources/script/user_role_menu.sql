...
/*Table structure for table `native_menu` */

DROP TABLE IF EXISTS `native_menu`;

CREATE TABLE `native_menu` (
...
/*Data for the table `native_user` */
